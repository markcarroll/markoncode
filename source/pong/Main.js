...
var winCount='3'; // the number of wins to end the game
...
{
	Tween.get(credits).to({x:480}, 200).call(rmvCredits);
}
...
function restart() 
{
	stage.removeChild(playerScore, cpuScore, player, cpu, ball);
	stage.update();	
	addTitleView();
}
function alert(e)
